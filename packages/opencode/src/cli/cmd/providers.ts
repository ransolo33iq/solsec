...
import { ModelsDev } from "@solsec-ai/core/models-dev"
...
import type { Hooks } from "@solsec-ai/plugin"
  ...
  handler: Effect.fn("Cli.providers.login")(function* (args) {
    ...
    if (provider === "other") {
      ...
      yield* Prompt.log.warn(
        `This only stores a credential for ${provider} - you will need configure it in solsec.json, check the docs for examples.`,
      )
    }
