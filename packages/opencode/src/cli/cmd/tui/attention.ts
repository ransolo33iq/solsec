...
} from "@solsec-ai/plugin/tui"
import stripAnsi from "strip-ansi"
import type { TuiConfig } from "./config/tui"
import { isAttentionSoundName } from "./config/tui-schema"
import * as TuiAudio from "@tui/util/audio"
import defaultSoundPath from "@solsec-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@solsec-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@solsec-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@solsec-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@solsec-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@solsec-ai/ui/audio/yup-01.mp3" with { type: "file" }
