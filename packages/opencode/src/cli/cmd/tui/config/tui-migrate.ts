...
/**
 * Migrates tui-specific keys (theme, keybinds, tui) from solsec.json files
...
async function opencodeFiles(input: { directories: string[]; cwd: string }) {
  const files = [
    ...
    ...(await Filesystem.findUp(["solsec.json", "solsec.jsonc"], input.cwd, undefined, { rootFirst: true })),
  ]
