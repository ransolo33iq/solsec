import { Slug } from "@solsec-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@solsec-ai/llm"
...
import { NonNegativeInt, optionalOmitUndefined } from "@solsec-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".solsec", "plans")
