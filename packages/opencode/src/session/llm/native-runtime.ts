...
import { tool as nativeTool, ToolFailure, type JsonSchema, type LLMEvent } from "@solsec-ai/llm"
import type { LLMClientShape } from "@solsec-ai/llm/route"
...
export function status(input: Pick<StreamInput, "model" | "provider" | "auth">): RuntimeStatus {
  ...
  if (providerID !== "openai" && providerID !== "anthropic" && !providerID.startsWith("solsec"))
