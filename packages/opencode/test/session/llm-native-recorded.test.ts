...
import { HttpRecorder, Redactor } from "@solsec-ai/http-recorder"
...
import { LLMEvent, LLMResponse } from "@solsec-ai/llm"
...
import type { ModelsDev } from "@solsec-ai/core/models-dev"
...
const writeConfig = (directory: string, spec: ProviderSpec, model: ModelsDev.Provider["models"][string]) =>
  Effect.promise(() =>
    Bun.write(
      path.join(directory, "solsec.json"),
