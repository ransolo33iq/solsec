  ...
  test("formats legacy and tagged config errors the same way", () => {
    const cases = [
      ...
      },
      {
        ...
        data: { path: "/tmp/opencode.jsonc", dir: ".solsec", suggestion: "opencode" },
        expected:
          'Directory ".solsec" in /tmp/opencode.jsonc is not valid. Rename the directory to "opencode" or remove it. This is a common typo.',
      },
      {
