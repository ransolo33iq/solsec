import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@solsec-ai/sdk/v2"
import { SessionTurn } from "@solsec-ai/ui/session-turn"
import { SessionReview } from "@solsec-ai/ui/session-review"
import { DataProvider } from "@solsec-ai/ui/context"
import { FileComponentProvider } from "@solsec-ai/ui/context/file"
import { WorkerPoolProvider } from "@solsec-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@solsec-ai/ui/logo"
import { IconButton } from "@solsec-ai/ui/icon-button"
import { ProviderIcon } from "@solsec-ai/ui/provider-icon"
import { iife } from "@solsec-ai/core/util/iife"
import { Binary } from "@solsec-ai/core/util/binary"
import { NamedError } from "@solsec-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@solsec-ai/ui/tabs"
import { MessageNav } from "@solsec-ai/ui/message-nav"
import { FileSSR } from "@solsec-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@solsec-ai/ui/pierre/worker").then((m) => ({
