...
beforeAll(async () => {
  ...
  mock.module("@solsec-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@solsec-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@solsec-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@solsec-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
